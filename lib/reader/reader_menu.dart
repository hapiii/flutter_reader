...
class _ReaderMenuState extends State<ReaderMenu> with SingleTickerProviderStateMixin {
          ...
          children: <Widget>[
            Container(
              ...
              child: GestureDetector(
                ...
                child: Image.asset(package: "reader", 'img/pub_back_gray.png'),
              ),
            ),
            Expanded(child: Container()),
            Container(
              width: 44,
              child: Image.asset(package: "reader", 'img/read_icon_voice.png'),
            ),
            Container(
              width: 44,
              child: Image.asset(package: "reader", 'img/read_icon_more.png'),
            ),
          ],
        ),
      ),
        ...
        children: <Widget>[
          GestureDetector(
            ...
            child: Container(
              ...
              child: Image.asset(package: "reader", 'img/read_icon_chapter_previous.png'),
            ),
          ),
          Expanded(
            child: Slider(
          ...
          GestureDetector(
            ...
            child: Container(
              padding: EdgeInsets.all(20),
              child: Image.asset(package: "reader", 'img/read_icon_chapter_next.png'),
            ),
          )
        ],
      ),
  ...
  buildBottomItem(String title, String icon) {
    return Container(
      ...
      child: Column(
        children: <Widget>[
          Image.asset(package: "reader", icon),
          SizedBox(height: 5),
