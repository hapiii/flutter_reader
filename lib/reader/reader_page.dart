...
class ReaderPageState extends State<ReaderPage> with RouteAware {
  ...
  void setup() async {
    ...
    List<dynamic> chaptersResponse = await ArticleProvider.fetchCatalog(123);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: AnnotatedRegion(
        ...
        child: Stack(
          children: <Widget>[
            Positioned(left: 0, top: 0, right: 0, bottom: 0, child: Image.asset(package: "reader", 'img/read_bg.png', fit: BoxFit.cover)),
            buildPageView(),
            buildMenu(),
          ],
        ),
